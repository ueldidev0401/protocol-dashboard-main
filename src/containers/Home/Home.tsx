...
import { ReactComponent as Logo } from 'assets/img/Logo-2-3.svg'
...
const messages = {
  ...
  wtfIsAudius: 'WTF is Asix+?',
  wtf1: `Asix+ is a digital streaming service that connects fans directly with artists and exclusive new music`,
  wtf2: `It does this by being fully decentralized: Asix+ is owned and run by a vibrant, open-source community of artists, fans, and developers all around the world. Asix+ gives artists the power to share never-before-heard music and monetize streams directly. Developers can build their own apps on top of Asix+, giving them access to one of the most unique audio catalogs in existence.`,
  wtf3: `Backed by an all-star team of investors, Asix+ was founded in 2018 and serves millions of users every month, making it the largest non-financial crypto application ever built.`
}
